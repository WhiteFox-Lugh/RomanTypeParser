...
public class ParseUnitTest
{
    ...
    [InlineData("じょばんのだんじょん", new int[7] { 7, 1, 2, 1, 1, 21, 2 })]
    ...
    [InlineData("あんあんというざっし", new int[8] { 1, 2, 1, 3, 2, 3, 1, 15 })]
    [InlineData("かんいけんさ", new int[5] { 2, 2, 2, 1, 3 })]
    [InlineData("うんうんうにうむ", new int[8] { 3, 2, 3, 2, 3, 1, 3, 1 })]
    [InlineData("はんえん", new int[4] { 1, 2, 1, 2 })]
    [InlineData("けんお", new int[3] { 1, 2, 1 })]
    [InlineData("はんかんをかう", new int[5] { 1, 6, 3, 2, 3 })]
    [InlineData("げんきんひゃくまんえん", new int[8] { 1, 3, 9, 3, 1, 2, 1, 2 })]
    ...
    [InlineData("けんにんじ", new int[4] { 1, 2, 1, 6 })]
    [InlineData("かんぬ", new int[3] { 2, 2, 1 })]
    [InlineData("いんねんのたいけつ", new int[9] { 2, 2, 1, 2, 1, 1, 2, 1, 2 })]
    [InlineData("はんはん", new int[3] { 1, 3, 2 })]
    [InlineData("ごせんふ", new int[3] { 1, 2, 6 })]
    [InlineData("めんぜんほんいつ", new int[6] { 1, 3, 3, 2, 2, 2 })]
    [InlineData("じんみん", new int[3] { 2, 3, 2 })]
    [InlineData("かんむてんのう", new int[6] { 2, 3, 1, 2, 1, 3 })]
    [InlineData("せんめんじょ", new int[3] { 2, 3, 21 })]
    [InlineData("だいかんやま", new int[6] { 1, 2, 2, 2, 1, 1 })]
    [InlineData("いんゆ", new int[3] { 2, 2, 1 })]
    [InlineData("かんよ", new int[3] { 2, 2, 1 })]
    ...
    [InlineData("さんざんなめにあう", new int[8] { 1, 3, 2, 1, 1, 1, 1, 3 })]
    ...
    [InlineData("はんにゃしんぎょう", new int[6] { 1, 2, 3, 3, 9, 3 })]
    [InlineData("れんにゅう", new int[4] { 1, 2, 3, 3 })]
    [InlineData("しんにょう", new int[4] { 3, 2, 3, 3 })]
    ...
    [InlineData("しっきゃく", new int[3] { 3, 15, 3 })]
    ...
    [InlineData("すっっっごい", new int[5] { 1, 4, 4, 5, 2 })]
